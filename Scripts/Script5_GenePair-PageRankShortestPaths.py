...
def gene_pair_specific_subnetwork(gene_pair, gene_pair_dict_pathway_info, 
                                  network_file="HIPPI_PPI_network_self_loops_removed.txt", 
...
def GenePairSpecificSubnetwork(gene_pair,GenePairDict_PathwayInformation , network_file =  "HIPPI_PPI_network_self_loops_removed.txt",PATH = 'GenePairSpecificSubnetworks-CeentralityMeasures'):
...
for gene_pair in Merged_GenePairDict_OneTwo_MoreThanTwoPathways.keys():
    GenePairSpecificSubnetwork(gene_pair,GenePairDict_PathwayInformation = Merged_GenePairDict_OneTwo_MoreThanTwoPathways, network_file =  "HIPPI_PPI_network_self_loops_removed.txt")   
